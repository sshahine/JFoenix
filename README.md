...
# Source Code
To rebuild JFoenix, you need to create an Ant file named build.xml and build.bat. JFoenix uses Java version 1.8. Using a command line, you need to move to the JFoenix/make directory
