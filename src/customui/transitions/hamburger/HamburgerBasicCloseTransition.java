package customui.transitions.hamburger;
...
public class HamburgerBasicCloseTransition extends CachedTimelineTransition {
	public HamburgerBasicCloseTransition(VBox burger) {
		super(
				burger,
				new Timeline(
						new KeyFrame(
