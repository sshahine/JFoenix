...
public class RipplerDemo extends Application {
	...
	@Override public void start(Stage stage) {
		...
		Rippler lrippler = new Rippler(l);
		...
		main.getChildren().add(new Rippler(l1));
		...
		main.getChildren().add(new Rippler(l3));
