...
public class C3DComboBoxListViewSkin<T> extends ComboBoxPopupControl<T> {
	...
	private final C3DComboBox<T> comboBox;
	...
	private final C3DListView<T> listView;
	...
	public C3DComboBoxListViewSkin(final C3DComboBox<T> comboBox) {
	...
	private C3DListView<T> createListView() {
		final C3DListView<T> _listView = new C3DListView<T>() {
	...
	public static final class FakeFocusTextField extends C3DTextField {
