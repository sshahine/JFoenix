...
//		errorLabel.minWidthProperty().bind(Bindings.createDoubleBinding(()->field.getWidth()/1.14, field.widthProperty()));
	...
	protected void layoutChildren(final double x, final double y, final double w, final double h) {
		...
		if(invalid){
			...
			cursorPane.backgroundProperty().bind(Bindings.createObjectBinding(()-> new Background(new BackgroundFill(((C3DTextField)getSkinnable()).getFocusColor(), CornerRadii.EMPTY, Insets.EMPTY)), ((C3DTextField)getSkinnable()).focusColorProperty()));
