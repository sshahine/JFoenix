...
import com.cctintl.c3dfx.skins.C3DPasswordFieldSkin;
import com.cctintl.c3dfx.validation.base.ValidatorBase;
import com.sun.javafx.css.converters.PaintConverter;



public class C3DPasswordField extends PasswordField {
	
	public C3DPasswordField() {
		super();
		initialize();
	}
	...
	private StyleableObjectProperty<Paint> unFocusColor = new SimpleStyleableObjectProperty<Paint>(StyleableProperties.UNFOCUS_COLOR, C3DPasswordField.this, "unFocusColor", Color.rgb(77, 77, 77));
	...
	private StyleableObjectProperty<Paint> focusColor = new SimpleStyleableObjectProperty<Paint>(StyleableProperties.FOCUS_COLOR, C3DPasswordField.this, "focusColor", Color.valueOf("#4059A9"));
	...
	private static class StyleableProperties {
		private static final CssMetaData<C3DPasswordField, Paint> UNFOCUS_COLOR = new CssMetaData<C3DPasswordField, Paint>("-fx-unfocus-color", PaintConverter.getInstance(), Color.rgb(77, 77, 77)) {
			@Override
			public boolean isSettable(C3DPasswordField control) {
				return control.unFocusColor == null || !control.unFocusColor.isBound();
			}

			@Override
			public StyleableProperty<Paint> getStyleableProperty(C3DPasswordField control) {
				return control.unFocusColorProperty();
			}
		};
		private static final CssMetaData<C3DPasswordField, Paint> FOCUS_COLOR = new CssMetaData<C3DPasswordField, Paint>("-fx-focus-color", PaintConverter.getInstance(), Color.valueOf("#4059A9")) {
			@Override
			public boolean isSettable(C3DPasswordField control) {
