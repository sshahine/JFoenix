...
import com.cctintl.c3dfx.skins.C3DTextFieldSkin;
...
public class C3DTextField extends TextField {
	...
	private static class StyleableProperties {
		private static final CssMetaData<C3DTextField, Paint> UNFOCUS_COLOR = new CssMetaData<C3DTextField, Paint>("-fx-unfocus-color", PaintConverter.getInstance(), Color.rgb(77, 77, 77)) {
			@Override
		...
		private static final CssMetaData<C3DTextField, Paint> FOCUS_COLOR = new CssMetaData<C3DTextField, Paint>("-fx-focus-color", PaintConverter.getInstance(), Color.valueOf("#4059A9")) {
			@Override
			public boolean isSettable(C3DTextField control) {
