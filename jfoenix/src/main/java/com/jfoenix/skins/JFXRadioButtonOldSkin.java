...
public class JFXRadioButtonOldSkin extends RadioButtonSkin {
    ...
    private void initializeComponents(final double x, final double y, final double w, final double h) {
        ...
        timeline = new Timeline(new KeyFrame(Duration.ZERO,
                                             new KeyValue(dot.radiusProperty(), minRadius, Interpolator.EASE_BOTH)),
                                new KeyFrame(Duration.millis(200), new KeyValue(dot.radiusProperty(),
                                                                                radioRadius + radio.getStrokeWidth() / 2,
