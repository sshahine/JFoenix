...
public class JFXPasswordFieldSkinAndroid extends TextFieldSkinAndroid {
    ...
    public JFXPasswordFieldSkinAndroid(JFXPasswordField field) {
        ...
        line.setBackground(new Background(new BackgroundFill(((JFXPasswordField) getSkinnable())
            .getUnFocusColor(),
        ...
        focusedLine.setBackground(new Background(new BackgroundFill(((JFXPasswordField) getSkinnable())
            .getFocusColor(),
            CornerRadii.EMPTY, Insets.EMPTY)));
        ...
        field.disabledProperty().addListener((o, oldVal, newVal) -> {
            line.setBorder(newVal ? new Border(new BorderStroke(((JFXPasswordField) getSkinnable())
                .getUnFocusColor(),
                BorderStrokeStyle.DASHED,
                CornerRadii.EMPTY,
                new BorderWidths(line.getHeight()))) : Border.EMPTY);
            line.setBackground(new Background(new BackgroundFill(newVal ? Color.TRANSPARENT : (
                (JFXPasswordField) getSkinnable())
                .getUnFocusColor(),
                CornerRadii.EMPTY, Insets.EMPTY)));
        });
    ...
    protected void handleControlPropertyChanged(String propertyReference) {
        if ("DISABLE_ANIMATION".equals(propertyReference)) {
            ...
            errorContainer.setClip(((JFXPasswordField) getSkinnable()).isDisableAnimation() ?
    ...
    protected void layoutChildren(final double x, final double y, final double w, final double h) {
        ...
        if (invalid) {
            ...
            final ValidatorBase activeValidator = ((JFXPasswordField) getSkinnable()).getActiveValidator();
