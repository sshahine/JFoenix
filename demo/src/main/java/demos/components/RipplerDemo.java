...
public class RipplerDemo extends Application {
  ...
  public static final TemplateBuilder<Node> HEART_BEAT =
  ...
  public static final TemplateBuilder<Node> FLASH =
      JFXAnimationTemplate.create()
          .from()
          .percent(50)
  ...
  public static final TemplateBuilder<Node> TADA =
      JFXAnimationTemplate.create()
          .from()
          .action(b -> b.target(Node::scaleXProperty, Node::scaleYProperty).endValue(1))
          .percent(10, 20)
    ...
    try {
      timer.addKeyFrame(
          new JFXKeyFrame(
              Duration.seconds(1),
              JFXKeyValue.builder()
                  .setTarget(rippler1.translateYProperty())
                  .setEndValue(100)
                  .build()));
      timer.start();
