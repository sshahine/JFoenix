...
import com.jfoenix.transitions.creator.JFXAnimationTemplates;
...
public class RipplerDemo extends Application {
  ...
  public static final JFXAnimationTemplate.Builder<Node> HEART_BEAT =
  ...
  public static final JFXAnimationTemplate.Builder<Node> FLASH =
      JFXAnimationTemplate.create()
                          .from()
                          .percent(50)
  ...
  public static final JFXAnimationTemplate.Builder<Node> TADA =
      JFXAnimationTemplate.create()
                          .from()
                          .action(b -> b.target(Node::scaleXProperty, Node::scaleYProperty).endValue(1))
                          .percent(10, 20)
